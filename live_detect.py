...
import cv2
face_cascade = cv2.CascadeClassifier('p106/haarcascade_frontalface_default.xml')
catface_cascade = cv2.CascadeClassifier('p106/haarcascade_frontalcatface.xml')
...
while(True):
    ...
    catfaces = catface_cascade.detectMultiScale(gray,1.1,5)
